...
class Config(object):
    def __init__(self, file_path, model, dataset, task, gpu):
        ...
        if isinstance(model, th.nn.Module):
            ...
            self.drop_edge = conf.getfloat('HAN', "drop_edge")
            ...
            self.drop_edge = conf.getfloat("HGT", "drop_edge")
            ...
            self.drop_edge = conf.getfloat("SimpleHGN", "drop_edge")
            ...
            self.drop_edge = conf.getfloat("HetSANN", "drop_edge")
            ...
            self.drop_edge = conf.getfloat("ieHGCN", "drop_edge")
