...
class ieHGCN(BaseModel):
    ...
    def __init__(self, num_layers, hidden_dim, out_dim, attn_dim, ntypes, etypes, bias, batchnorm, dropout,drop_edge):
...
class ieHGCNConv(nn.Module):
    ...
    def __init__(self, in_size, out_size, attn_size, ntypes, etypes, activation = F.elu, 
                 bias = False, batchnorm = False, dropout = 0.0,drop_edge=.2):
